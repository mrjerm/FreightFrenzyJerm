...
public class MeepMeepTesting {
    public static void main(String[] args) {
        Pose2d shippingHub = new Pose2d(-23, 36, Math.toRadians(-108));
        Pose2d duckSpinner = new Pose2d(-64, -55, Math.toRadians(180));
        Pose2d storageHub = new Pose2d(64, -55, Math.toRadians(180));
        ...
        RoadRunnerBotEntity jermBot = new DefaultBotBuilder(meepoSheepo)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-36, -64.625, Math.PI))
                                .lineToLinearHeading(duckSpinner)
                                .build());
        meepoSheepo
