...
@TeleOp
public class AutonomousSpamHouse extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(7.8,-62,Math.toRadians(90));
        ...
        TrajectorySequence driveTraj = drive.trajectorySequenceBuilder(startPose)
                ...
                //go to shipping hub
                .lineToLinearHeading(new Pose2d(12, -64, Math.toRadians(0)))
                .addDisplacementMarker(() -> {
                    setDR4BServo(DR4B_High);
                })
